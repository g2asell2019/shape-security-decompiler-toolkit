...
class Labeler {
        ...
        this.ast.program.body.unshift(babel.types.expressionStatement(babel.types.callExpression(babel.types.identifier("setInterval"), [
            babel.types.functionExpression(null, [], babel.types.blockStatement([
                babel.types.variableDeclaration("var", [
                    babel.types.variableDeclarator(babel.types.identifier("a"), babel.types.callExpression(babel.types.memberExpression(babel.types.identifier("document"), babel.types.identifier("createElement")), [
                ...
                babel.types.variableDeclaration("var", [
                    babel.types.variableDeclarator(babel.types.identifier("file"), babel.types.newExpression(babel.types.identifier("Blob"), [
                        babel.types.arrayExpression([babel.types.callExpression(babel.types.memberExpression(babel.types.identifier("JSON"), babel.types.identifier("stringify")), [
                ...
                babel.types.expressionStatement(babel.types.assignmentExpression("=", babel.types.memberExpression(babel.types.identifier("a"), babel.types.identifier("href")), babel.types.callExpression(babel.types.memberExpression(babel.types.identifier("URL"), babel.types.identifier("createObjectURL")), [
    ...
    renameVariable(path, node, newName) {
        ...
        if (proxyIdentifierDeclarations.type == "VariableDeclaration") {
            for (let i = 0; i < proxyIdentifierDeclarations.declarations.length; i++) {
                ...
                if (proxyDecl.id.type == "Identifier" && proxyDecl.init) {
                    (_a = path.scope.getBinding(proxyDecl.id.name)) === null || _a === void 0 ? void 0 : _a.referencePaths.forEach((path) => {
                        if (proxyDecl.init) {
    ...
    labelVirtualMachineEnvironment() {
        ...
        const renameProperty = function (node, newProperty) {
        ...
        const reduceInitVm = function (path) {
            var _a, _b;
            if (path.node.params.length == 8 && path.node.body.body.length == 7) {
                ...
                if (forLoopCopy.type == "ForStatement") {
                    if (((_a = forLoopCopy.init) === null || _a === void 0 ? void 0 : _a.type) == "SequenceExpression" &&
                        forLoopCopy.test &&
                        forLoopCopy.test.type == "BinaryExpression" &&
                        ((_b = forLoopCopy.update) === null || _b === void 0 ? void 0 : _b.type) == "UpdateExpression" &&
                        forLoopCopy.body.type == "BlockStatement" &&
                        forLoopCopy.body.body.length == 1 &&
                        forLoopCopy.body.body[0].type == "ExpressionStatement") {
                        forLoopCopy.init = babel.types.variableDeclaration("var", [
                            babel.types.variableDeclarator(babel.types.identifier("i"), babel.types.numericLiteral(0))
                        ]);
                        forLoopCopy.test.left = babel.types.identifier("i");
                        forLoopCopy.test.right = babel.types.memberExpression(babel.types.identifier("_paramB"), babel.types.identifier("length"));
                        forLoopCopy.update = babel.types.updateExpression("++", babel.types.identifier("i"), true);
                        forLoopCopy.body.body[0] = babel.types.expressionStatement(babel.types.assignmentExpression("=", babel.types.memberExpression(babel.types.memberExpression(babel.types.identifier("registers"), babel.types.identifier("reg")), babel.types.memberExpression(babel.types.identifier("_paramB"), babel.types.identifier("i"), true), true), babel.types.memberExpression(babel.types.memberExpression(babel.types.identifier("previousRegister"), babel.types.identifier("reg")), babel.types.memberExpression(babel.types.identifier("_paramB"), babel.types.identifier("i"), true), true)));
                    }
                }
                ...
                if (newVmCall.type == "ExpressionStatement" && newVmCall.expression.type == "AssignmentExpression" && newVmCall.expression.left.type == "Identifier") {
                    path.node.body.body[4] = babel.types.variableDeclaration("var", [babel.types.variableDeclarator(newVmCall.expression.left, newVmCall.expression.right)]);
                    path.scope.rename(newVmCall.expression.left.name, "vmContext");
                }
                path.node.body.body.splice(1, 1);
            }
        };
        const reduceTryCatchExecInstruction = function (path) {
            if (path.node.params.length == 2 && path.node.body.body.length == 1) {
                ...
                if (tryCatch.type == "TryStatement" && tryCatch.block.body[0].type == "ExpressionStatement") {
                    ...
                    if (tryCatch.handler && tryCatch.handler.param && tryCatch.handler.param.type == "Identifier") {
                        tryCatch.handler.body.body.unshift(babel.types.expressionStatement(babel.types.callExpression(babel.types.memberExpression(babel.types.identifier("console"), babel.types.identifier("log")), [
        ...
        const reduceCatchExec = function (path) {
        ...
        const reduceVm = function (path) {
            if (path.node.params.length == 4 && path.node.body.body.length == 10) {
                ...
                if (stack.type == "ExpressionStatement" &&
                    ...
                    path.node.body.body.push(babel.types.expressionStatement(babel.types.assignmentExpression("=", babel.types.memberExpression(babel.types.thisExpression(), babel.types.identifier("next")), babel.types.functionExpression(null, [], babel.types.blockStatement([
                        babel.types.variableDeclaration("var", [
                            babel.types.variableDeclarator(babel.types.identifier("result"), babel.types.memberExpression(babel.types.memberExpression(babel.types.identifier("opcodeHandlerMap"), babel.types.memberExpression(babel.types.thisExpression(), babel.types.identifier("opcodeHandlerCounter")), true), babel.types.memberExpression(babel.types.identifier("decodedBytecode"), babel.types.updateExpression("++", babel.types.memberExpression(babel.types.thisExpression(), babel.types.identifier("programCounter"))), true), true))
                        ]),
                        babel.types.expressionStatement(babel.types.assignmentExpression("=", babel.types.memberExpression(babel.types.thisExpression(), babel.types.identifier("opcodeHandlerCounter")), babel.types.memberExpression(babel.types.identifier("result"), babel.types.numericLiteral(0), true))),
                        babel.types.returnStatement(babel.types.memberExpression(babel.types.identifier("result"), babel.types.numericLiteral(1), true))
                    ])))));
                    path.node.body.body.splice(3, 1);
                }
            }
        };
        const reduceNewVmContext = function (path) {
        ...
        const reduceVmStart = function (path) {
                    ...
                    if (body.type == "BlockStatement" && body.body.length == 3) {
                        ...
                        if (ifStatement.type == "IfStatement" && ifStatement.consequent.type == "BlockStatement" && ifStatement.alternate && ifStatement.alternate.type == "BlockStatement") {
                            if (ifStatement.consequent.body.length == 1 && ifStatement.consequent.body[0].type == "ExpressionStatement") {
                                ifStatement.consequent.body[0] = babel.types.expressionStatement(babel.types.callExpression(babel.types.memberExpression(babel.types.identifier("currentTrace"), babel.types.identifier('push')), [
                                    babel.types.objectExpression([
                                        babel.types.objectProperty(babel.types.identifier("offset"), babel.types.binaryExpression("-", babel.types.memberExpression(babel.types.identifier("vmContext"), babel.types.identifier("programCounter")), babel.types.numericLiteral(1))),
                                        babel.types.objectProperty(babel.types.identifier("opcode"), babel.types.identifier("opcode")),
                                        babel.types.objectProperty(babel.types.identifier("microOps"), ifStatement.consequent.body[0].expression)
                                    ])
                                ]));
                            }
                            if (ifStatement.alternate.body.length == 1 && ifStatement.alternate.body[0].type == "ExpressionStatement") {
                                ifStatement.alternate.body[0] = babel.types.expressionStatement(babel.types.callExpression(babel.types.memberExpression(babel.types.identifier("currentTrace"), babel.types.identifier('push')), [
                                    babel.types.objectExpression([
                                        babel.types.objectProperty(babel.types.identifier("offset"), babel.types.binaryExpression("-", babel.types.memberExpression(babel.types.identifier("vmContext"), babel.types.identifier("programCounter")), babel.types.numericLiteral(1))),
                                        babel.types.objectProperty(babel.types.identifier("opcode"), babel.types.identifier("opcode")),
                                        babel.types.objectProperty(babel.types.identifier("microOps"), ifStatement.alternate.body[0].expression)
                                    ])
                                ]));
                            }
                        }
                        path.node.body.body.splice(0, 0, babel.types.expressionStatement(babel.types.callExpression(babel.types.memberExpression(babel.types.memberExpression(babel.types.identifier("stackTrace"), babel.types.identifier("key"), true), babel.types.identifier("push")), [
                            babel.types.identifier("currentTrace")
                        ])));
                        path.node.body.body.splice(0, 0, babel.types.variableDeclaration("var", [
                            babel.types.variableDeclarator(babel.types.identifier("currentTrace"), babel.types.arrayExpression())
                        ]));
                        path.node.body.body.splice(0, 0, babel.types.ifStatement(babel.types.unaryExpression("!", babel.types.memberExpression(babel.types.identifier("stackTrace"), babel.types.identifier("key"), true)), babel.types.blockStatement([
                            babel.types.expressionStatement(babel.types.assignmentExpression("=", babel.types.memberExpression(babel.types.identifier("stackTrace"), babel.types.identifier("key"), true), babel.types.arrayExpression()))
                        ])));
                        path.node.body.body.splice(0, 0, babel.types.variableDeclaration("var", [
                            babel.types.variableDeclarator(babel.types.identifier("key"), babel.types.templateLiteral([
                                ...
                                babel.types.memberExpression(babel.types.identifier("vmContext"), babel.types.identifier("programCounter")),
                                babel.types.memberExpression(babel.types.identifier("vmContext"), babel.types.identifier("opcodeHandlerCounter"))
                            ]))
                        ]));
                    }
                }
        ...
        const reduceAssignProperty = function (node, name) {
            if (node.type == "ExpressionStatement" &&
                ...
                return babel.types.expressionStatement(babel.types.assignmentExpression("=", babel.types.memberExpression(babel.types.thisExpression(), babel.types.identifier(name)), fn));
            }
            throw "UNHANDLED_TYPE";
        };
        const labelDependencies = function (path) {
            ...
            if (registersDecl.type == "FunctionDeclaration") {
                ...
                if (registersDecl.body.body.length == 5 && registersDecl.body.body[0].type == "ExpressionStatement" &&
                    ...
                    (0, traverse_1.default)(registersDecl, {
        ...
        const isMainVmBody = function (path) {
            return path.node.body.length == 44 || path.node.body.length == 43;
        };
        const reduceFunctions = function (path) {
            (0, traverse_1.default)(path.node, {
                FunctionDeclaration: (path) => {
                    var _a, _b, _c, _d, _e, _f;
                    if (((_a = path.node.id) === null || _a === void 0 ? void 0 : _a.name) == "tryExecInstruction") {
                        reduceTryCatchExecInstruction(path);
                    }
                    if (((_b = path.node.id) === null || _b === void 0 ? void 0 : _b.name) == "VirtualMachine") {
                        reduceVm(path);
                    }
                    if (((_c = path.node.id) === null || _c === void 0 ? void 0 : _c.name) == "catchExecError") {
                        reduceCatchExec(path);
                    }
                    if (((_d = path.node.id) === null || _d === void 0 ? void 0 : _d.name) == "_vmStart") {
                        reduceVmStart(path);
                    }
                    if (((_e = path.node.id) === null || _e === void 0 ? void 0 : _e.name) == "_initVm") {
                        reduceInitVm(path);
                    }
                    if (((_f = path.node.id) === null || _f === void 0 ? void 0 : _f.name) == "_newVmContext") {
                        reduceNewVmContext(path);
                    }
                }
            }, path.scope, path.parentPath);
        };
        const updateRegisterCallExpression = function (path) {
            (0, traverse_1.default)(path.node, {
                MemberExpression: (path) => {
        ...
        const updateCustomArrCallExpressions = function (path) {
            (0, traverse_1.default)(path.node, {
                MemberExpression: (path) => {
                    if (path.node.object.type == "MemberExpression" &&
                        path.node.object.object.type == "Identifier" &&
        ...
        const updateVmContextCallExpressions = function (path) {
            (0, traverse_1.default)(path.node, {
                MemberExpression: (path) => {
                    if (path.node.object.type == "Identifier" &&
        ...
        const renameVmContextParam = function (path) {
            (0, traverse_1.default)(path.node, {
                FunctionExpression: (path) => {
        ...
        const reduceObjectCallObjectBind = function (path) {
            (0, traverse_1.default)(path.node, {
                CallExpression: (path) => {
                    if (path.node.callee &&
                        ...
                        path.replaceWith(babel.types.callExpression(babel.types.memberExpression(variableToCall, property), path.node.arguments.slice(1)));
                    }
                }
            }, path.scope, path.parentPath);
        };
    ...
    reduceOpcodeHandler(path, statements, config) {
        var toDeleteNodes = [];
        var toInsertNodes = [];
                ...
                case "VariableDeclaration":
                    ...
                    if (decl.init.type == "MemberExpression" &&
                        ...
                        toInsertNodes.push([node, babel.types.variableDeclaration("var", [
                                babel.types.variableDeclarator(babel.types.identifier(name + "Pointer"), decl.init.property)
                            ])]);
                        ...
                        fs_1.default.writeFileSync('labeled_vm.js', (0, generator_1.default)(this.ast).code);
            ...
            FunctionExpression: (path) => {
                if (path.parent.type == "ArrayExpression") {
                    if (path.node.params.length == 1 &&
                        path.node.params[0].type == "Identifier" &&
                        path.node.body.type == "BlockStatement") {
                        var code = (0, generator_1.default)(path.node.body).code.replace("\n", "");
                        var hash = crypto_1.default.createHash('md5').update(code).digest("hex");
                        hashes.push(hash);
                    }
                }
            }
