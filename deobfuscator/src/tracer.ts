...
export class Tracer {
  ...
  private traverseStatementsAndInjectTracer(
    ...
    function isMemberExpressionVmStack(
    ...
    function isMemberExpressionVmProgramCounter(
      node: babel.types.MemberExpression
    ): boolean {
      return (
        node.object.type == "Identifier" &&
    ...
    function isMemberExpressionVmOpcodeCounter(
      node: babel.types.MemberExpression
    ): boolean {
      return (
        node.object.type == "Identifier" &&
    ...
    function isMemberExpressionVmRegister(
      node: babel.types.MemberExpression
    ): boolean {
      return (
        node.object.type == "Identifier" &&
    ...
    function createGetGlobalEmptyObj(pointer: babel.types.BinaryExpression) {
      return babel.types.objectExpression([
        ...
        babel.types.objectProperty(
          ...
          babel.types.arrayExpression([createRawValue(pointer)])
        ),
      ]);
    }
    function createStackSliceArg(
      start: babel.types.Expression,
      end: babel.types.Expression
    ) {
      return babel.types.objectExpression([
        babel.types.objectProperty(
          babel.types.identifier("type"),
    ...
    function createNewOpcodeFunctionArg(
      programCounter: babel.types.Expression,
      opcodeHandlerCounter: babel.types.Expression
    ) {
      return babel.types.objectExpression([
        babel.types.objectProperty(
          babel.types.identifier("type"),
    ...
    function createFetchArg(
      method: "register" | "stack" | "function",
      pointer: babel.types.Expression
    ): babel.types.ObjectExpression {
      return babel.types.objectExpression([
        babel.types.objectProperty(
          babel.types.identifier("type"),
    ...
    function translateIdentifierToArgument(
      ...
      if (node.name.includes("byte") || node.name.includes("rawString$")) {
        ...
        return createFetchArg(
          "stack",
          babel.types.identifier(node.name + "Pointer")
        );
    ...
    function translateNewExpression(
      node: babel.types.NewExpression
    ): babel.types.ObjectExpression {
    ...
    function translateMemberExpression(
      node: babel.types.MemberExpression
    ): babel.types.ObjectExpression {
    ...
    function translateExpressionToArgument(
      node: babel.types.Expression
    ): babel.types.ObjectExpression {
      switch (node.type) {
        case "Identifier":
        ...
        case "CallExpression":
          if (
            ...
            if (
              programCounter.type != "ArgumentPlaceholder" &&
              ...
              return createNewOpcodeFunctionArg(
                programCounter,
                opcodeHandlerCounter
              );
            }
            throw "unkn";
          } else if (
          ...
          if (node.object.type == "Identifier") {
            if (node.object.name == "numberArray") {
              ...
              return createIdentifier(
                babel.types.stringLiteral(node.property.name)
              );
            } else if (node.property.type == "Identifier") {
              return translateMemberExpression(node);
            } else if (
              node.object.name == "globalEmptyObj" &&
    ...
    function createMicroOpLabel(
      instruction: string,
      args: babel.types.ObjectExpression[]
    ...
    function checkIfPushOp(node: babel.types.Statement) {
      if (
        ...
        if (
          ...
          if (
            node.expression.right.left.property.type != "BinaryExpression" &&
            !(
              node.expression.right.left.property.type == "Identifier" &&
              node.expression.right.left.property.name.includes(
                "binaryExpression"
              )
            )
          ) {
          ...
          var rightAssignmentNode = translateIdentifierToArgument(
    ...
    function checkIfJMPNode(
      node: babel.types.Statement,
      consequentNode: babel.types.Statement
    ) {
      if (
        node.type == "ExpressionStatement" &&
        node.expression.type == "AssignmentExpression" &&
    ...
    function checkIfSetRegister(node: babel.types.Statement) {
      if (
        ...
        if (
          location.type != "ArgumentPlaceholder" &&
    ...
    function checkIfDefineProperty(node: babel.types.Statement) {
      if (
        ...
        if (value.properties.length == 3) {
          ...
          if (
            valueSet.value.type == "ArrayPattern" ||
    ...
    function checkifDefineArray(node: babel.types.Statement) {
      if (
        ...
        if (
          node.declarations[0].init.callee.name.includes("createOpcodeFunction")
        ) {
          var args = [
    ...
    function checkIfSaveNumber(node: babel.types.Statement) {
      if (
        node.type == "VariableDeclaration" &&
        node.declarations.length == 1 &&
        node.declarations[0].type == "VariableDeclarator" &&
    ...
    function checkIfSaveMemberExpression(node: babel.types.Statement) {
      if (
        node.type == "VariableDeclaration" &&
        node.declarations.length == 1 &&
        node.declarations[0].type == "VariableDeclarator" &&
    ...
    function checkIfBinaryExpressionVariable(node: babel.types.Statement) {
      if (
        node.type == "VariableDeclaration" &&
        node.declarations.length == 1 &&
        node.declarations[0].type == "VariableDeclarator" &&
    ...
    function checkIfSetGlobalEmptyObject(node: babel.types.Statement) {
      if (
        ...
        if (
          node.declarations[0].init.left.property.type != "BinaryExpression" &&
          !(
            node.declarations[0].init.left.property.type == "Identifier" &&
            node.declarations[0].init.left.property.name.includes(
              "binaryExpression"
            )
          )
        ) {
        ...
        nodesToInsert.push([
          node,
          createMicroOpLabel("SET_GLOBAL_EMPTY_OBJECT", [
            translateExpressionToArgument(
              node.declarations[0].init.left.property
            ),
        ...
        if (
          ...
          var ifStatementInstruction = createMicroOpLabel("IF_BRANCH", [
            ...
            babel.types.objectExpression([
              babel.types.objectProperty(
                babel.types.identifier("type"),
                babel.types.stringLiteral("body")
              ),
              babel.types.objectProperty(
    ...
    nodesToInsert.forEach((pair) => {
      ...
      var block = babel.types.labeledStatement(
        ...
        babel.types.blockStatement([pair[1], pair[0]])
      );
  ...
  injectTracer(): string {
    ...
    this.ast.program.body.unshift(
      babel.types.expressionStatement(
        babel.types.callExpression(babel.types.identifier("setInterval"), [
            ...
            babel.types.blockStatement([
              ...
              babel.types.variableDeclaration("var", [
                babel.types.variableDeclarator(
                  ...
                  babel.types.newExpression(babel.types.identifier("Blob"), [
                    babel.types.arrayExpression([
                      babel.types.callExpression(
                        babel.types.memberExpression(
