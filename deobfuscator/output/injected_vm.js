...
(function T(window) {
  ...
  function Registers() {
    ...
    this.get = function (bo) {
      return this.reg[bo].v;
    };

    this.set = function (bP, bg) {
      this.reg[bP].v = bg;
    };

    this.clone = function () {
      var bO = new Registers();
      bO.reg = [].slice !== [].slice ? this.reg.slice(0) : this.reg.slice(0);
      return bO;
    };
  }
  ...
  function tryExecInstruction(opcodeHandler, vmContext) {
    try {
      ...
      console.log(bB);
      catchExecError(bB, vmContext);
    }
  }

  function catchExecError(bd, vmContext) {
    var bM = vmContext.vStack.pop();
    ...
    vmContext.programCounter = bM.z;
    vmContext.opcodeHandlerCounter = bM.S;
  }
  ...
  var instructionHandlers = {
    0: function (vmContext) {
      ...
      a: {
        ...
        if (typeof globalEmptyObj[rawString$0$ + "," + byte$0] !== "undefined") {
          var rawString$4$ = globalEmptyObj[rawString$0$ + "," + byte$0];
          break a;
        }
        ...
        for (var i = 1; i < rawString$2.length; ++i) {
          rawString$4 += String.fromCharCode(rawString$3[i] ^ rawString$2[i] ^ rawString$2[0] + rawString$3[0] & 255);
        }
        ...
        hook_VariableDeclaration: {
          microOps.push({
            ...
            args: [{
              type: "raw",
              value: rawString$0$ + "," + byte$0
            }, {
              type: "raw",
              value: rawString$4
            }]
          });
          var rawString$4$ = globalEmptyObj[rawString$0$ + "," + byte$0] = rawString$4;
        }
      }

      var stackLength = vmContext.stack.length;
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength] = rawString$4$;
      }
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength + 1] = null;
      }
    ...
    5: function (vmContext) {
      ...
      var stackLength = vmContext.stack.length - 1;
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength] = rawString$0;
      }
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength + 1] = vmContext.registers.get(byte$1);
      }
    ...
    7: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength] = vmContext.registers.get(byte$0);
      }
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength + 1] = vmContext.registers.get(byte$0);
      }
    ...
    8: function (vmContext) {
      var microOps = [];
      var rawString$0 = encodedStringArray[decodedBytecode[vmContext.programCounter] << 8 | decodedBytecode[vmContext.programCounter + 1]];
      var rawString$1 = encodedStringArray[decodedBytecode[vmContext.programCounter + 2] << 8 | decodedBytecode[vmContext.programCounter + 3]];
      var byte$0 = decodedBytecode[vmContext.programCounter + 4] << 8 | decodedBytecode[vmContext.programCounter + 5];
      vmContext.programCounter += 6;
      var rawString$1$ = rawString$1;

      if (typeof globalEmptyObj[rawString$1$ + "," + byte$0] !== "undefined") {
        var oldMicroOps = microOps;
        var branchBody = [];
        microOps = branchBody;
        var stackLength = vmContext.stack.length;
        ...
        hook_ExpressionStatement: {
          microOps.push({
            ...
            args: [{
              ...
              type: "getGlobalEmptyObj",
              args: [{
                type: "raw",
                value: rawString$1$ + "," + byte$0
              }]
            }]
          });
          vmContext.stack[stackLength + 1] = globalEmptyObj[rawString$1$ + "," + byte$0];
        }
      ...
      var rawString$4 = decodeString(rawString$1$);
      var rawString$5 = "";

      for (var i = 1; i < rawString$3.length; ++i) {
        rawString$5 += String.fromCharCode(rawString$4[i] ^ rawString$3[i] ^ rawString$3[0] + rawString$4[0] & 255);
      }
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength + 1] = globalEmptyObj[rawString$1$ + "," + byte$0] = rawString$5;
      }
      ...
      hook_ExpressionStatement: {
        microOps.push({
          ...
          args: [{
            ...
            type: "raw",
            value: numberArray[decodedBytecode[vmContext.programCounter]]
          }]
        });
        vmContext.stack[vmContext.stack.length] = numberArray[decodedBytecode[vmContext.programCounter]];
      }
    ...
    15: function (vmContext) {
      ...
      var stackLength = vmContext.stack.length - 3;
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength] = stack$0;
      }
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength + 1] = byte$0;
      }
    ...
    17: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.registers.set(byte$1, stack$0 | byte$0);
      }
    ...
    19: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength] = array$0;
      }
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength + 2] = rawString$0;
      }
    ...
    22: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        microOps.push({
          ...
          args: [{
            type: "raw",
            value: vmContext.reg.N
          }, {
            type: "raw",
            value: vmContext.reg.S
          }]
        });
        vmContext.programCounter = vmContext.reg.N;
      }
    ...
    24: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength + 2] = byte$1;
      }
    ...
    25: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[vmContext.stack.length - 1] = stack$0 + byte$0;
      }
    ...
    27: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength + 2] = vmContext.registers.get(byte$2);
      }
    ...
    29: function (vmContext) {
      ...
      if (typeof globalEmptyObj[stack$0 + "," + byte$0] !== "undefined") {
        var oldMicroOps = microOps;
        var branchBody = [];
        microOps = branchBody;
        ...
        hook_ExpressionStatement: {
          ...
          vmContext.stack[vmContext.stack.length - 1] = globalEmptyObj[stack$0 + "," + byte$0];
        }
      ...
      for (var i = 1; i < rawString$1.length; ++i) {
        rawString$3 += String.fromCharCode(rawString$2[i] ^ rawString$1[i] ^ rawString$1[0] + rawString$2[0] & 255);
      }
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[vmContext.stack.length - 1] = globalEmptyObj[stack$0 + "," + byte$0] = rawString$3;
      }
    ...
    32: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[vmContext.stack.length - 2] = stack$1 | stack$0 >>> byte$0;
      }
    ...
    34: function (vmContext) {
      ...
      var stack$3Pointer = vmContext.stack.length - 4;
      var stack$3 = vmContext.stack[vmContext.stack.length - 4];
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.registers.set(byte$1, stack$3);
      }
    ...
    35: function (vmContext) {
      ...
      if (!(stack$0 == vmContext.registers.get(byte$0))) {
        var oldMicroOps = microOps;
        var branchBody = [];
        microOps = branchBody;
    ...
    36: function (vmContext) {
      ...
      if (typeof globalEmptyObj[rawString$0$ + "," + byte$0] !== "undefined") {
        ...
        hook_ExpressionStatement: {
          ...
          vmContext.stack[stackLength + 1] = stack$0;
        }
        ...
        hook_ExpressionStatement: {
          ...
          vmContext.stack[stackLength + 2] = globalEmptyObj[rawString$0$ + "," + byte$0];
        }
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength + 2] = globalEmptyObj[rawString$0$ + "," + byte$0] = rawString$4;
      }
    ...
    38: function (vmContext) {
      ...
      var rawString$1 = encodedStringArray[decodedBytecode[vmContext.programCounter + 3] << 8 | decodedBytecode[vmContext.programCounter + 4]];
      vmContext.programCounter += 5;
      var stackLength = vmContext.stack.length;
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength + 2] = rawString$1;
      }
    ...
    42: function (vmContext) {
      ...
      hook_VariableDeclaration: {
        ...
        var fn_call$1 = stack$2$(fn_call$0);
      }
    ...
    46: function (vmContext) {
      var microOps = [];
      ++vmContext.vStack[vmContext.vStack.length - 1].D;
      return microOps;
    },
    47: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[vmContext.stack.length - 2] = [];
      }
    ...
    49: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.programCounter = prevCounter.H;
      }
    ...
    50: function (vmContext) {
      ...
      if (typeof globalEmptyObj[rawString$0$ + "," + byte$0] !== "undefined") {
        ...
        hook_ExpressionStatement: {
          ...
          vmContext.stack[stackLength + 1] = globalEmptyObj[rawString$0$ + "," + byte$0];
        }
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength + 1] = globalEmptyObj[rawString$0$ + "," + byte$0] = rawString$4;
      }
    ...
    54: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.registers.set(byte$1, null);
      }
    ...
    57: function (vmContext) {
      ...
      if (typeof globalEmptyObj[rawString$0$ + "," + byte$0] !== "undefined") {
        ...
        hook_ExpressionStatement: {
          ...
          vmContext.stack[stackLength] = vmContext.window$2;
        }
    ...
    58: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[vmContext.stack.length] = 2e308;
      }
    ...
    62: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength] = stack$2 | stack$0 >>> stack$1;
      }
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength + 1] = stack$2 | stack$0 >>> stack$1;
      }
    ...
    63: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[vmContext.stack.length - 1] = RegExp(rawString$4$, stack$0);
      }
    ...
    64: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[vmContext.stack.length - 1] = stack$0[rawString$4$]();
      }
    ...
    66: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.registers.set(byte$1, array$0);
      }
    ...
    67: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength + 1] = byte$1;
      }
    ...
    71: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[vmContext.stack.length] = byte$0 & vmContext.registers.get(byte$1);
      }
    ...
    77: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength + 2] = vmContext.registers.get(byte$0);
      }
    ...
    82: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.registers.set(byte$2, byte$1);
      }
    ...
    85: function (vmContext) {
      ...
      var stack$1Pointer = vmContext.stack.length - 1;
      var stack$1 = vmContext.stack[vmContext.stack.length - 1];
      var stackLength = vmContext.stack.length - 2;
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength] = stack$0 & stack$1;
      }
    ...
    88: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength + 2] = byte$2;
      }
    ...
    89: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength] = vmContext.registers.get(byte$1);
      }
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength + 1] = byte$2;
      }
    ...
    95: function (vmContext) {
      ...
      a: {
        ...
        if (typeof globalEmptyObj[stack$0$ + "," + byte$0] !== "undefined") {
          var rawString$3$ = globalEmptyObj[stack$0$ + "," + byte$0];
          break a;
        }
        ...
        hook_VariableDeclaration: {
          ...
          var rawString$3$ = globalEmptyObj[stack$0$ + "," + byte$0] = rawString$3;
        }
      }
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength] = rawString$3$;
      }
    ...
    96: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[vmContext.stack.length - 2] = stack$0$(stack$1, vmContext.registers.get(byte$0), vmContext.registers.get(byte$1));
      }
    ...
    98: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.programCounter = prevCounter.z;
      }
    ...
    100: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength] = byte$0;
      }
    ...
    102: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        Object.defineProperty(stack$0, rawString$0, {
          writable: true,
          configurable: true,
          enumerable: true,
    ...
    104: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength + 1] = rawString$0;
      }
    ...
    106: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.registers.set(byte$1, fn_call$1);
      }
    ...
    110: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[vmContext.stack.length - 2] = vmContext.registers.get(byte$0);
      }
    ...
    111: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[vmContext.stack.length - 2] = stack$0$(stack$1, rawString$4$);
      }
    ...
    114: function (vmContext) {
      ...
      var stackLength = vmContext.stack.length - 4;
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength] = stack$2;
      }
    ...
    129: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength + 2] = vmContext.registers.get(byte$1);
      }
    ...
    138: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[vmContext.stack.length - 1] = String(vmContext.registers.get(byte$0));
      }
    ...
    141: function (vmContext) {
      ...
      a: {
        ...
        if (typeof globalEmptyObj[rawString$0$ + "," + byte$0] !== "undefined") {
          var rawString$5$ = globalEmptyObj[rawString$0$ + "," + byte$0];
          break a;
        }
        ...
        hook_VariableDeclaration: {
          ...
          var rawString$5$ = globalEmptyObj[rawString$0$ + "," + byte$0] = rawString$5;
        }
      }
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength] = rawString$5$;
      }
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength + 1] = rawString$1;
      }
    ...
    151: function (vmContext) {
      ...
      hook_VariableDeclaration: {
        ...
        var fn_call$0 = Number(vmContext.registers.get(byte$0));
      }
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[vmContext.stack.length] = fn_call$0;
      }
    ...
    154: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.registers.set(byte$0, prevCounter.H);
      }
    ...
    161: function (vmContext) {
      ...
      var rawString$0 = encodedStringArray[decodedBytecode[vmContext.programCounter] << 8 | decodedBytecode[vmContext.programCounter + 1]];
      var byte$0 = decodedBytecode[vmContext.programCounter + 2] << 8 | decodedBytecode[vmContext.programCounter + 3];
      var byte$1 = decodedBytecode[vmContext.programCounter + 4];
      vmContext.programCounter += 5;
    ...
    162: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.registers.set(byte$0, stack$2 | stack$0 << stack$1);
      }
    ...
    167: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[vmContext.stack.length - 1] = String(stack$0);
      }
    ...
    174: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength] = stack$0 << byte$0;
      }
      ...
      hook_ExpressionStatement: {
        microOps.push({
          ...
          args: [{
            ...
            type: "raw",
            value: numberArray[decodedBytecode[vmContext.programCounter + 1]]
          }]
        });
        vmContext.stack[stackLength + 1] = numberArray[decodedBytecode[vmContext.programCounter + 1]];
      }
    ...
    175: function (vmContext) {
      ...
      var stack$1 = vmContext.stack[vmContext.stack.length - 2];
      var stack$1$ = stack$1;
      var c$0 = new stack$1$(rawString$3$);
      throw c$0;
      vmContext.stack.length -= 2;
      return microOps;
    },
    ...
    196: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[vmContext.stack.length] = byte$0 * byte$1;
      }
    ...
    205: function (vmContext) {
      ...
      if (typeof globalEmptyObj[rawString$0$ + "," + byte$1] !== "undefined") {
        var oldMicroOps = microOps;
        var branchBody = [];
        microOps = branchBody;
        var stackLength = vmContext.stack.length;
        ...
        hook_ExpressionStatement: {
          microOps.push({
            ...
            args: [{
              ...
              args: [{
                type: "raw",
                value: rawString$0$ + "," + byte$1
              }]
            }]
          });
          vmContext.stack[stackLength + 1] = globalEmptyObj[rawString$0$ + "," + byte$1];
        }
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength + 1] = globalEmptyObj[rawString$0$ + "," + byte$1] = rawString$4;
      }
    ...
    218: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength] = vmContext.stack[vmContext.stack.length - 1];
      }
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength + 1] = vmContext.stack[vmContext.stack.length - 1];
      }
    ...
    220: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength] = byte$3;
      }
    ...
    223: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength] = fn_call$0;
      }
    ...
    229: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength] = stack$0 != vmContext.registers.get(byte$0);
      }
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[stackLength + 1] = stack$0 != vmContext.registers.get(byte$0);
      }
    ...
    231: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[vmContext.stack.length - 1] = stack$0$(vmContext.registers.get(byte$0), vmContext.registers.get(byte$1));
      }
    ...
    232: function (vmContext) {
      ...
      if (typeof globalEmptyObj[rawString$0$ + "," + byte$1] !== "undefined") {
        ...
        hook_ExpressionStatement: {
          ...
          vmContext.stack[vmContext.stack.length - 1] = globalEmptyObj[rawString$0$ + "," + byte$1];
        }
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[vmContext.stack.length - 1] = globalEmptyObj[rawString$0$ + "," + byte$1] = rawString$4;
      }
    ...
    235: function (vmContext) {
      ...
      hook_ExpressionStatement: {
        ...
        vmContext.stack[vmContext.stack.length] = T;
      }
  ...
  function _newVmContext(programCounter, opcodeHandlerCounter, prevRegisters, _paramA, _paramC, isParamDUndefined, _paramD) {
    var vmStart = function () {
      ...
      var rX,
          rd,
          ry = Math.min(arguments.length, _paramC.length);
      ...
      for (rX = 0, rd = _paramA.length; rX < rd; ++rX) {
        registers.init(_paramA[rX]);
      }

      for (rX = 0; rX < ry; ++rX) {
        registers.set(_paramC[rX], arguments[rX]);
      }

      for (rX = ry; rX < _paramC.length; ++rX) {
        registers.set(_paramC[rX], void 0);
      }
